...
<body>
      <header>
            <h1 style="color:whitesmoke;font-size: 60px">
                  <a href="index.php"><img src="banklogo.jpg">SF Bank</a>
            </h1>
      ...
      <table class="customers">
            ...
            while ($row = mysqli_fetch_array($res)) {
                  ...
                  echo "</td>";
                  echo "<td>";
                  echo $row["Current Balance"];
                  echo "</td>";
                  echo "<td>"; ?><a
                        href="SelectandTransfer.php? id=<?php echo $row["id"]; ?>"><button>Transfer</button></a>
                  <?php echo "</td>";
                  echo "</tr>";
            }
            $conn->close();
      ...
      <footer>
            <p style="color:white"><i>&#169; copyright 2021. Made by D A Ritesh</i></p>
            <p style="color:white"><i>All rights reserved. Powered by<a
                              href="https://internship.thesparksfoundation.info/">The Sparks Foundation</a></i></p>
      </footer>
