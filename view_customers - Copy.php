...
<body>
      ...
      <table class="customers">
            ...
            while ($row = mysqli_fetch_array($res)) {
                  ...
                  echo "</td>";
                  echo "<td>"; ?><a href="SelectandTransfer.php? id=<?php echo $row["id"]; ?>"><button>Transfer</button></a>
                  <?php echo "</td>";
                  echo "</tr>";
            }
            $conn->close();
      ...
      <footer>
            ...
            <p style="color:white"><i>All rights reserved. Powered by<a
                              href="https://www.thesparksfoundationsingapore.org/">The Sparks Foundation</a></i></p>
      </footer>
